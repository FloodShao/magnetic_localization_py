...
SensorPosition = {
    ...
    5: 1e-3 * np.array([50, -120, 50]),
    6: 1e-3 * np.array([50, -120, -50]),
    7: 1e-3 * np.array([-50, -120, -50]),
    8: 1e-3 * np.array([-50, -120, 50]),

    9: 1e-3 * np.array([-50, 120, 50]),
    10: 1e-3 * np.array([-50, 120, -50]),
    11: 1e-3 * np.array([50, 120, -50]),
    12: 1e-3 * np.array([50, 120, 50]),
